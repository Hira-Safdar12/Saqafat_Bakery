      ...
      <section className="pp-hero" aria-label="Partners hero">
        ...
        <div className="pp-hero-content">
          ...
          <button
            ...
            onClick={() => {
              document.getElementById('pp-cards')?.scrollIntoView({
                behavior: 'smooth',
              });
            }}
          >
        ...
        <div className="pp-stats-inner">
          ...
          <div className="pp-section-head">
            ...
            <p className="pp-section-sub">
              Backed by 15 years of excellence and thousands of loyal customers
              across Pakistan.
            </p>
          </div>
...
function ContactModal({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const body = `New ${form.partnerType} Inquiry
...
${form.message}`;
    ...
    window.location.href = `mailto:partners@saqafatbakery.com?subject=${encodeURIComponent(
      `${form.partnerType} Inquiry - ${form.name}`
    ...
    >
      <div className="pp-modal">
        ...
        <div className="pp-modal-header">
          ...
          <h2 id="pp-modal-title" className="pp-modal-title">
            {card.title}
          </h2>
          ...
          <form className="pp-form" onSubmit={handleSubmit} noValidate>
            ...
            <div className="pp-field-row">
              ...
              <div className="pp-field">
                ...
                {errors.name && (
                  <span className="pp-error-msg">{errors.name}</span>
                )}
              </div>
              ...
              <div className="pp-field">
                ...
                {errors.email && (
                  <span className="pp-error-msg">{errors.email}</span>
                )}
              </div>
            ...
            <div className="pp-field-row">
              ...
              <div className="pp-field">
                ...
                {errors.phone && (
                  <span className="pp-error-msg">{errors.phone}</span>
                )}
              </div>
              ...
              <div className="pp-field">
                ...
                {errors.city && (
                  <span className="pp-error-msg">{errors.city}</span>
                )}
              </div>
            ...
            <div className="pp-field">
              <label className="pp-label" htmlFor="pp-message">
                ...
                <span className="pp-required">*</span>
              </label>

              <textarea
                id="pp-message"
                className={`pp-input pp-textarea${
                  errors.message ? ' pp-input-error' : ''
                }`}
                placeholder="Tell us about your interest, investment capacity, city you are targeting, etc."
                rows={4}
                value={form.message}
              ...
              {errors.message && (
                <span className="pp-error-msg">{errors.message}</span>
              )}
            </div>
